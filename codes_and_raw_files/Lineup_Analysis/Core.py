...
shot_attempt = re.compile(r'([A-Z]+ {0,1}?[A-Z]+)\.?\,([A-Z]+\'{0,1}?[A-Z]+) .* (jump shot|layup|dunk|tip-in)')
two_made = re.compile(r'([A-Z]+ {0,1}?[A-Z]+)\.?\,([A-Z]+\'{0,1}?[A-Z]+) made (jump shot|layup|dunk|tip-in)')
