...
'Richard Rapp', 'Israel Dosie', 'Jamal Turner', 'Chad Abbadessa', 'Hassan Basbous', 'Landen Gladney', 
'Raymond Falk', 'Jonathan Turner', 'Izak Ruddell', 'Louis Fernando'],
...
'Mack Knueppel', 'Herkstroeter Mason', 'Baehman Stephen', 'Vancrete Alex', 'Bernhagen Drew', 'Paul Koier',
'Collin Kennedy', 'Anthony Mendoza', 'Bailey Jon', 'Zuleger Zach', 'Beiermann Braden'],
 
['Edgewood College (WI) Eagles','Mcclain Steffens', 'Sy Staver', 'Will Schwartz', 'Tyler Lemke', 
'Avery Lyons', 'Jake Negus', 'Ryan Buss', 'Jacob Miller', 'Hill Caleb', 'Matthew Myers', 'Caleb Holzman', 
'Emil Radisevic', 'Jake Graf', 'Eli Hartjes', 'Ben Seefeld', 'Jaden Lechelt', 'Anthony Janega'],

['Illinois Tech Scarlet Hawks','Anthony Mosley', 'Ben Wagner', 'Heath Sheridan', 'Ahmad Muhammad',
 'Jake Bruns', 'Jalen Lomax', 'Calvin Schmitz', 'Capriest Gardner', 'Brett Ott', 'Jake Digiorgio', 'Max Hisatake',
  'Otis Reale', 'Milos Dugalic', 'Cody Mattson', 'Parker Joncus', 'Guy Ostroff', 'Ricardo Whitehead', 'Kohl Linder', 'Zach Parduhn'],
...
'Deonte Vanselow', 'David Llorente', 'Gabe Wear', 'Ty Miklowski', 'Jake Gebert', 'Will Busch', 'Matt Powers',
